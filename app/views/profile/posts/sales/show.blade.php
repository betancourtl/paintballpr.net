...
@section('breadcrumb-small')  My Posts @stop
@section('breadcrumb-link') {{link_to_route('home','Home')}} @stop
@section('breadcrumb-active')  My Posts @stop
@section('content')
                ...
                <table class="table table-responsive table-striped table-hover">
                    ...
                    @foreach($posts as $post)
                        ...
                        <tr>
                            ...
                            <td>{{link_to_route('posts-edit-sales','Edit',array($post->id),['class' =>'btn btn-info'])}}</td>
                            <td>
                                {{Form::open(array('method'=>'Post', 'route' => array('sales-destroy',$post->id ))) }}
